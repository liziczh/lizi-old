              ...
              <div class="layui-row layui-col-space15 layui-form-item">
                <div class="layui-col-md3">
                  ...
                  <div class="layui-input-block">
                    <select id="dir" lay-verify="required" name="class" lay-filter="column">
                      <option></option>
                ...
                <div class="layui-col-md9">
                  ...
                  <div class="layui-input-block">
                    <input type="text" id="L_title" name="title" value="${requestScope.post.postTitle}" required lay-verify="required" placeholder="文章标题" autocomplete="off" class="layui-input">
                  </div>
                </div>
              </div>
              <div class="layui-form-item layui-form-text">
                <div class="layui-input-block">
                  <textarea id="L_content" name="content" required lay-verify="required" placeholder="文章内容" class="layui-textarea fly-editor" style="height: 260px;">${requestScope.post.postContent}</textarea>
                </div>
              </div>
              <div class="layui-form-item">
                <input type="submit" value="发布内容" class="layui-btn" lay-filter="*">
              </div>
            </form>
          </div>
        </div>
...
<script>
    layui.use(['jquery'], function(){
        var $ = jQuery = layui.$;
        $('#dir option').each(function(i,n) {
            if($(n).text() == '${requestScope.post.dir}'){
