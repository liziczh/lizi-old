package com.liziczh.erp.common.response;

import com.liziczh.erp.common.code.BaseRestCode;
import com.liziczh.erp.common.constant.BaseRestConstants;
...
public class BaseRestResponse<T> implements Serializable {
   ...
   public static BaseRestResponse ok() {
      return new Builder(BaseRestCode.REST_OK, BaseRestConstants.REST_OK).build();
   }
   public static <T> BaseRestResponse ok(T body) {
      return new Builder<>(BaseRestCode.REST_OK, BaseRestConstants.REST_OK, body).build();
   }
   public static <T> BaseRestResponse ok(T body, Object extra) {
      return new Builder<>(BaseRestCode.REST_OK, BaseRestConstants.REST_OK, body, extra).build();
   }
